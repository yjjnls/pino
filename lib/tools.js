...
function getPrettyStream (opts, prettifier, dest) {
  ...
  try {
    var prettyFactory = require('@yjjnls/pino-pretty')
    prettyFactory.asMetaWrapper = prettifierMetaWrapper
    return prettifierMetaWrapper(prettyFactory(opts), dest)
  } catch (e) {
    throw Error('Missing `@yjjnls/pino-pretty` module: `@yjjnls/pino-pretty` must be installed separately')
  }
}
